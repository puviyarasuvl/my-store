...
describe('Testing Order Model', function () {
    describe('index method', function () {
        it('should return all the orders', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, orderModel.index('testUser1')];
                    case 1:
                        result = _a.sent();
    ...
    describe('Testing Order Products', function () {
        describe('addProduct method', function () {
            it('should create an open order and add product', function () { return __awaiter(void 0, void 0, void 0, function () {
                var result;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, orderModel.addProduct(3, 5, 'testUser1')];
                        case 1:
                            result = _a.sent();
            ...
            it('should add the product successfully', function () { return __awaiter(void 0, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, orderModel.addProduct(2, 3, 'testUser1')];
                        case 1:
                            result = _a.sent();
                            expect(result).toEqual({
                                id: 2,
